...
git submodule add https://github.com/SergioRando/js-gallery.git
```
...
```
cd {Project Path}/src/lib
git submodule deinit js-gallery
git rm js-gallery
git commit -m "Removed submodule js-gallery"
cd {Project Path}
rm -rf ./git/modules/src/lib/js-gallery
```
